...
token = "TOKEN"
bot = telebot.TeleBot(283163349:AAG5KNGSyEBVi-F9j1BQF3dvQkf5gh7PI6A)
opizo_email = 'rezazarei51589@gmail.com'
start_msg = '*hi mr :) dev by : @whh_reza*'
...
def all(m):
  try:
            ...
            bot.send_message(m.chat.id,'<b>تبریک فایل آپلود شد!</b>\n\n<b>لینک فایل شما:</b>\n{}\n\n<b>ساخته شده توسط:</b> \W-H-H REZA | @whh_reza'.format(lin1),parse_mode='HTML')
  except:
